...
<%
	...
	if(title ==""||title==null) out.println("title가 null입니다.");
	...
	try{
		...
		String url= "jdbc:oracle:thin:@localhost:1521:XE";//접속URL정보와 포트번호,sid
		
		Class.forName(driverName);
		
		Connection con =DriverManager.getConnection(url,"board","board");//getCo...:계정정보 url,id,pw
		
		out.println("Oracle데이터베이스 db에 성공적으로 접속했습니다.");
		...
		out.println("Oracle 데이터베이스 db 접속에 문제가있습니다.<hr>");
